...
const talentSteps = [
  {
    number: "01",
    title: "Apply",
    description: "Submit your TV credits and social presence. We review every application personally.",
  },
  {
    number: "02",
    title: "Get Matched",
    description: "Paired with a dedicated manager who audits your brand and starts getting you booked.",
  },
  {
    number: "03",
    title: "Get Paid",
    description: "Receive curated briefs, deliver content, collect payment. We handle everything else.",
  },
]
...
const brandSteps = [
  {
    ...
    description: "Campaign objectives, budget, and target audience. We learn your brand first.",
  },
  {
    number: "02",
    title: "We Match You",
    description: "Handpicked talent based on audience alignment, content style, and campaign fit.",
  },
  {
    number: "03",
    title: "Launch",
    description: "Approve content, go live, track performance. Full reporting on reach and ROI.",
  },
]
