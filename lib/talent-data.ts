...
export const talentRoster: TalentProfile[] = [
  {
    ...
    credits: [
      { show: "The Challenge", network: "MTV", seasons: "3 Seasons", role: "Cast" },
    ],
    following: "1.2M",
    engagement: "4.8%",
    networks: ["MTV"],
  ...
  },
  {
    ...
    credits: [
      ...
      { show: "The Real World", network: "MTV", seasons: "1 Season", role: "Cast" },
    ],
    following: "1.8M",
    engagement: "4.5%",
    networks: ["OWN", "MTV"],
  ...
  },
  {
    ...
    credits: [
      { show: "MasterChef", network: "Food Network", seasons: "2 Seasons", role: "Contestant" },
  ...
  },
  {
    ...
    credits: [
      ...
      { show: "Ridiculousness", network: "MTV", seasons: "1 Season", role: "Featured" },
    ],
    following: "1.1M",
    engagement: "4.1%",
    networks: ["MTV"],
  ...
  },
  {
    ...
    credits: [
      { show: "Love Island USA", network: "USA Network", seasons: "2 Seasons", role: "Cast" },
      { show: "Temptation Island", network: "USA Network", seasons: "1 Season", role: "Guest" },
    ],
    following: "2.3M",
    engagement: "3.9%",
